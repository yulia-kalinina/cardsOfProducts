Это пэт-приложение со списком карточек продуктов. На каждой из карточек выводится картинка и некоторая информация, которая пришла с эндпоинта (в данном случае CatAPI) или была создана пользователем. 
